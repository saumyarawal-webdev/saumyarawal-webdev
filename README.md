...
[![Rex Docs](https://img.shields.io/badge/Rex-Docs-7C3AED?style=flat-square)](https://rex-docs.vercel.app)
![Express](https://img.shields.io/badge/Express.js-Core-000000?style=flat-square&logo=express&logoColor=white)
![Vite](https://img.shields.io/badge/Vite-Middleware-646CFF?style=flat-square&logo=vite&logoColor=white)
...
- Uses `server.js` as the Express-led entry point, with `api/routes.js` for backend logic and `src/` for the React UI.
- Ships with a clean API calling pattern using **React Query** and **Axios** for cached, maintainable client data fetching.
